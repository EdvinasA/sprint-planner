title = "Historical sprint from back-end";
startDate = "2021-10-13T00:00:00.000Z";
endDate = "2021-10-21T00:00:00.000Z";
sprintId = 0;
isHistorical = true;
...
class task {
    constructor(id, key, description, type, oldPoints, remainingPoints, newPoints, buttonColor, sprintId, show){
        this.id = id
        this.key = key;
